...
class GwMapzoneManager:
    ...
    def manage_config(self, dialog=None, tableview=None, *args, **kwargs):
        ...
        # Use a base message and format the key project_type differences
        base_msg = (
            ...
            "4- If you want to configure a {what_closed} that will always be closed for this mapzone, "
        ...
        what_closed = "arc" if global_vars.project_type == 'ud' else "node"
        msg = base_msg.format(what_closed=what_closed)
