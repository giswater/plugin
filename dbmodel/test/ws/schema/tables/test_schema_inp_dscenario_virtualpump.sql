...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'status', 'effic_curve_id', 'energy_price', 'energy_pattern_id', 'pump_type', 'observ'
    ],
...
SELECT col_type_is('inp_dscenario_virtualpump', 'observ', 'text', 'Column observ should be text');
