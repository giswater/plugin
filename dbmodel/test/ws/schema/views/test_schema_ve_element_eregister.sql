...
SELECT col_type_is('ve_element_eregister', 'p_state', 'int2', 'Column p_state should be int2');
SELECT col_type_is('ve_element_eregister', 'is_operative', 'bool', 'Column is_operative should be bool');
