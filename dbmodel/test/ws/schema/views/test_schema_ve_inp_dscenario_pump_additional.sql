...
SELECT columns_are(
    ...
    ARRAY[
        ...
        'pattern_id', 'status', 'effic_curve_id', 'energy_price', 'energy_pattern_id', 'the_geom', 'observ'
    ],
...
SELECT col_type_is('ve_inp_dscenario_pump_additional', 'observ', 'text', 'Column observ should be text');
