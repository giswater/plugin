...
SELECT col_type_is('ve_connec_cjoin', 'p_arc_id', 'int4', 'Column p_arc_id should be int4');
SELECT col_type_is('ve_connec_cjoin', 'p_pjoint_id', 'int4', 'Column p_pjoint_id should be int4');
SELECT col_type_is('ve_connec_cjoin', 'p_pjoint_type', 'varchar(16)', 'Column p_pjoint_type should be varchar(16)');
