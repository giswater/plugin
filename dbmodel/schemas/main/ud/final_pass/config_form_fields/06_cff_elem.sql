...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_ecover','form_feature','tab_data','expl_id','lyt_data_1',16,'integer','combo','Exploitation id:','Exploitation id',NULL,false,false,true,false,NULL,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:green; font-weight:bold;"}','{"setMultiline": false}',NULL,NULL,false,20),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_egate','form_feature','tab_data','expl_id','lyt_data_1',16,'integer','combo','Exploitation id:','Exploitation id',NULL,false,false,true,false,NULL,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:green; font-weight:bold;"}','{"setMultiline": false}',NULL,NULL,false,20),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_eiot_sensor','form_feature','tab_data','expl_id','lyt_data_1',16,'integer','combo','Exploitation id:','Exploitation id',NULL,false,false,true,false,NULL,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:green; font-weight:bold;"}','{"setMultiline": false}',NULL,NULL,false,20),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_eprotector','form_feature','tab_data','expl_id','lyt_data_1',16,'integer','combo','Exploitation id:','Exploitation id',NULL,false,false,true,false,NULL,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:green; font-weight:bold;"}','{"setMultiline": false}',NULL,NULL,false,20),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_estep','form_feature','tab_data','expl_id','lyt_data_1',16,'integer','combo','Exploitation id:','Exploitation id',NULL,false,false,true,false,NULL,'SELECT expl_id as id, name as idval FROM exploitation WHERE expl_id IS NOT NULL',true,false,NULL,NULL,'{"label":"color:green; font-weight:bold;"}','{"setMultiline": false}',NULL,NULL,false,20),
