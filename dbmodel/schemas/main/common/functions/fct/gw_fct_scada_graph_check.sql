...
- when commitChanges is true, writes om_scada_graph_json via gw_fct_scada_graph_export
  ...
  row_id - generated by pgr_drivingDistance, represents the de depth from the ROOT nodes of each connected component
  column_id - generated by pgr_depthFirstSearch, represents the order of the nodes on each level (row_id), it is calculated for minimising the number of crossing lines in the synoptic
  order_id in the table "om_scada_graph" - is the row_id of node_1
