...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_ecover','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_ecover','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''COVER'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_ecover','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''COVER'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
AND CASE 
  ...
  ELSE id < 2 
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ('ve_element_ehydrant_plate','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_element_ehydrant_plate','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_ehydrant_plate','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''HYDRANT_PLATE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_ehydrant_plate','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''HYDRANT_PLATE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
AND CASE 
  ...
  ELSE id < 2 
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ('ve_element_emanhole','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_element_emanhole','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_emanhole','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''MANHOLE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_emanhole','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''MANHOLE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ('ve_element_emeter','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,5),
	 ...
	 ('ve_element_emeter','form_feature','tab_data','ownercat_id','lyt_data_1',12,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,17),
...
AND CASE 
  ...
  ELSE id < 2 
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ('ve_element_eprotect_band','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_element_eprotect_band','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_eprotect_band','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''EPROTECT_BAND'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_eprotect_band','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''EPROTECT_BAND'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_element_epump','form_feature','tab_data','ownercat_id','lyt_data_1',12,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,17),
	 ('ve_element_epump','form_feature','tab_data','brand_id','lyt_data_1',13,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''EPUMP'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,18),
	 ('ve_element_epump','form_feature','tab_data','model_id','lyt_data_1',14,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''EPUMP'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,19),
	 ...
	 ('ve_element_epump','form_feature','tab_data','muni_id','lyt_data_3',1,'integer','combo','Municipality:','Muni_id - Municipality to which the element belongs. If the configuration is not modified, the program automatically selects it based on the geometry',NULL,false,false,true,false,NULL,'SELECT muni_id as id, name as idval from v_ext_municipality WHERE muni_id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "valueRelation": {"layer": "ve_municipality", "activated": true, "keyColumn": "muni_id", "nullValue": false, "valueColumn": "name", "filterExpression": null}}',NULL,NULL,false,25),
...
AND CASE 
  ...
  ELSE id < 2 
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ('ve_element_eregister','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ...
	 ('ve_element_eregister','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_eregister','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''EREGISTER'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_eregister','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''EREGISTER'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,3),
	 ...
	 ('ve_element_estep','form_feature','tab_data','ownercat_id','lyt_data_1',11,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,15),
	 ('ve_element_estep','form_feature','tab_data','brand_id','lyt_data_1',12,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''ESTEP'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,16),
	 ('ve_element_estep','form_feature','tab_data','model_id','lyt_data_1',13,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''ESTEP'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,17),
...
AND CASE 
  ...
  ELSE id < 2 
END',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,4),
	 ('ve_element_evalve','form_feature','tab_data','state_type','lyt_bot_1',3,'integer','combo','State Type:','State Type',NULL,false,false,true,false,NULL,'SELECT id, name as idval FROM v_value_state_type WHERE id IS NOT NULL',true,false,NULL,NULL,NULL,'{"setMultiline": false, "labelPosition": "top"}',NULL,NULL,false,5),
	 ...
	 ('ve_element_evalve','form_feature','tab_data','ownercat_id','lyt_data_1',12,'string','combo','Owner Catalog:','Owner Catalog',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_owner WHERE id IS NOT NULL AND active IS TRUE',true,true,NULL,NULL,NULL,'{"setMultiline":false}',NULL,NULL,false,17),
	 ('ve_element_evalve','form_feature','tab_data','brand_id','lyt_data_1',13,'text','combo','Brand:','Brand_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand WHERE ''EVALVE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,18),
	 ('ve_element_evalve','form_feature','tab_data','model_id','lyt_data_1',14,'text','combo','Model:','Model_id',NULL,false,false,true,false,NULL,'SELECT id, id as idval FROM cat_brand_model WHERE ''EVALVE'' = ANY(featurecat_id::text[]) OR featurecat_id IS NULL',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,false,19),
